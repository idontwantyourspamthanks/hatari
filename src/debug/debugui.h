...
/* The DEBUGGER_* code, not the bool ParseLine collapses it to. CMDCONT
 * (a repeatable line such as `d`) is not END (leave the debugger). */
extern int DebugUI_ParseLineCode(const char *input);
